  ...
  return (
    ...
    <div className='col-6 mx-auto'>
        ...
        <form onSubmit={submitHandler}>
            ...
            {errors.title ? <span className='text-danger'> {errors.petname1.message}</span> : null }<br></br>
            ...
            {errors.creador ? <span className='text-danger'>{errors.pettype.message} </span>: null} <br />

            <label htmlFor="" className='form-label'>Pet Description </label>
            <input type="text" className='form-control'onChange={(e)=>setDescription(e.target.value)}/>
            {errors.creador ? <span className='text-danger'>{errors.petdescription.message} </span>: null} <br />
            ...
            {errors.creador ? <span className='text-danger'>{errors.skill1.message} </span>: null} <br />
            ...
            {errors.creador ? <span className='text-danger'>{errors.skill2.message} </span>: null} <br />
            ...
            {errors.creador ? <span className='text-danger'>{errors.skill3.message} </span>: null} <br />
            ...
            <input type="text" className='form-control'onChange={(e)=>setAdd(e.target.value)}/>
